...
# Set local variables
#
featureclassin = "CSAMapUnitPolys"
featureclassout = "CSAMapUnitPolys"
...
print "Append orientation data to " + featureclassout + " " + " complete. . ."
